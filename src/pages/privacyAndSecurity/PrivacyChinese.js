    ...
    return (
      <Container className="secondary_font pb-5">
        ...
        <p>
          ...
          modify your profile, set preferences, or sign up for our Service. You
          also have the option to add your phone number, job title, country of
          residence, and other details to your profile information. We keep
          track of your preferences when you select settings within our Service.
        </p>
        <p>
        ...
        <p>
          <strong>Content you provide through our website</strong>: This policy
          also includes websites owned by or operated by Cialfo. We collect
          other content that you submit to these websites, like your email
          address, social media information, and job title and description.
        </p>
        <p>
          <strong>Information you provide through our support channels</strong>:
          You may choose to submit information to our customer support channels
          about a problem you’re experiencing with our Service. Whether you
          designate yourself as a technical contact, open a support ticket,
          speak to one of our representatives directly, or otherwise engage with
          our support team, you will be asked to provide a summary of the
          problem you’re experiencing and other documentation, screenshots, or
        ...
        <p>
          ...
          size, and file names of attachments you upload to Cialfo; and how you
          interact with others on our Service.
        </p>
        <p>
          <strong>Your device information</strong>: We collect information about
          your computer, phone, tablet, or other devices you use to access our
          Service. This device information includes your connection type and
          settings when you install, access, update, or use our Service. We also
          collect information through your device about your operating system,
          browser type, Internet Protocol (IP) address, URLs of referring/exit
          pages, device identifiers, and crash data. We use your IP address
          and/or country preference in order to approximate your location to
          provide you with a better experience. How much of this information we
          collect depends on the type and settings of the device you use to
          access the Service.
        </p>
        <p>
          <strong>Cookies and similar third-party tracking technologies</strong>
          ...
          this could affect certain features or services of our Sites.
        </p>
        <p>
          ...
          are tiny graphic images with a unique identifier, similar in function
          to Cookies, that are used to track online movements of Web users. In
          contrast to Cookies, which are stored on a user’s computer hard drive,
          Pixel Tags are embedded invisibly in Web pages. Pixel Tags also allow
          us to send e-mail messages and determine whether those e-mails have
        ...
        <ul>
          <li>
            ...
            database management services). These third parties are permitted to
            use your personal information only to perform these tasks in a
            manner consistent with this Privacy Policy and are obligated not to
          ...
          <li>
            ...
            parties as required by law, and disclose and use such information as
            we believe necessary or appropriate to (a) comply with applicable
            ...
            and (e) protect, investigate and deter against fraudulent, harmful,
        ...
        <p>
          ...
          be reached at <a href="mailto:hello@cialfo.co">hello@cialfo.co</a>.
        </p>
      </Container>
    );
  }
