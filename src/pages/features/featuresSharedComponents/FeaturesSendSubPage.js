...
import FeaturesSendBullets from "./FeaturesBullets";
import MobileFeaturesSendBullets from "./MobileFeaturesBullets";
import Oval from "../../../img/Oval.svg";
import Line from "../../../img/Line.svg";
import MediaQuery from "react-responsive";
import { withRouter } from "react-router-dom";

class FeaturesSendSubPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <Container className="featuresSendPage" fluid={true}>
        ...
        <FeaturesRightSideText
          ...
          bullets={this.props.topRowBullets}
        />
        <FeaturesLeftSideText
          setSpace={this.props.setSpace}
          setAccessToken={this.props.setAccessToken}
          image={this.props.middleRowImage}
          title={this.props.middleRowTitle}
          bullets={this.props.middleRowBullets}
        />
        <FeaturesRightSideText
          setSpace={this.props.setSpace}
          setAccessToken={this.props.setAccessToken}
          ...
          bullets={this.props.bottomRowBullets}
        />
      </Container>
    );
  }
}
export default withRouter(FeaturesSendSubPage);
